...
| CERT-OPEN-009 | Unit and integration reports | Open | Unit coverage report at 100%, full EMV test-plan integration report, and Level 3/acquirer bulletin reconciliation where the accepted test plan requires it; the pre-lab quality gate manifest does not close accepted report attachments | Coverage and integration reports are attached and match the submitted binary, profiles, annex hashes, accepted test-tool package, and Level 3/acquirer reconciliation notes. |
...
| CERT-OPEN-012 | APDU trace pack | Open | Masked APDU traces for all applicable lab/test-tool cases and Level 3/acquirer trace expectations where selected; the pre-lab fixture does not close the full lab trace pack requirement | Full lab trace pack is attached, replayable, masked, and tied to submitted profile/build identifiers, accepted test-tool package, and Level 3/acquirer reconciliation notes. |
