...
### Annex J – Certification Evidence Checklist
...
current attachment status. The checklist is an attachment-control artifact only.
It SHALL NOT mark an open issue closed without the independently accepted
