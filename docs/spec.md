...
### Annex J – Certification Evidence Checklist, Intake Ledger, Freeze Manifest, and Security Assessment Plan
...
These are attachment-control artifacts only. They SHALL NOT mark an open issue
closed without the independently accepted external evidence named by that row.
