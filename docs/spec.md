...
slots and unmapped files, and SHALL NOT mark any external evidence gate closed.
...
and attachment audit JSON/Markdown for that workspace without treating empty
directories or local files as accepted certification evidence.
