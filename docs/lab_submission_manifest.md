...
- [x] Pre-lab quality gate manifest (`prelab_quality_gates.json`) – deterministic local gate list generated by `cargo run --example krn_prelab_quality_gates`; formal coverage, integration, static-analysis, and fuzzing reports remain pending
