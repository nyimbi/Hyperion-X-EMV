...
- [x] Pre-lab decoder utility (`krn_emv_decode`) – controlled TLV, DOL, CVM-list, TVR, TSI, CID, GENERATE AC response, SW1/SW2, short command APDU, and response APDU envelope decoder with default payload suppression for lab-trace triage; not a substitute for full lab trace-pack evidence
