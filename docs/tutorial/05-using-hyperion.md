...
`CERT-OPEN-007`. `krn_certification_report_ui` emits a static workbench and
JSON/Markdown exports that index repository artifacts, pending external
reports, evidence attachments, and the commands needed to regenerate evidence.
