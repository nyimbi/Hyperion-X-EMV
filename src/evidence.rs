...
pub const EVIDENCE_REQUIREMENTS: &[EvidenceRequirement] = &[
    ...
    EvidenceRequirement {
        ...
        required_attachment: "100% unit coverage report plus full EMV test-plan integration report for the submitted build",
        required_metadata: "source commit, target triple, feature set, profile hash, CAPK hash, test-tool version, report hash, and deviations",
