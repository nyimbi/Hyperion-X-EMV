...
const MECHANISMS: &[VerificationMechanism] = &[
    ...
    VerificationMechanism {
        ...
        ci_gate: "Data-driven certification bundle artifact drift; checked-in bundle validation; checked-in bundle lint; wizard smoke; example compile",
        status: "repo-controlled",
        external_closure_gate: "CERT-OPEN-002; CERT-OPEN-003; CERT-OPEN-004; CERT-OPEN-005; CERT-OPEN-009; CERT-OPEN-012",
    },
    VerificationMechanism {
        id: "TOOL-PRODUCTIZATION-SDK",
        area: "SDK and distribution",
        purpose: "ship first-class CLI commands, formal schemas, submission-pack assembly, C ABI headers, Python helpers, starter kits, and repeatable development containers for product teams",
        repository_artifacts: &[
            "src/cli.rs",
            "src/bin/hyperion.rs",
            "src/productization.rs",
            "src/authority_format.rs",
            "include/hyperion_emv.h",
            "docs/schemas/certification-data-bundle.schema.json",
            "docs/schemas/integration-manifest.schema.json",
            "docs/schemas/report-pack.schema.json",
            "docs/schemas/freeze-manifest.schema.json",
            "docs/productization.md",
            "python/hyperion_tools/cli.py",
            "Makefile",
            "Dockerfile",
        ...
        commands: &[
            ...
            "cargo run --quiet --bin hyperion -- schemas write --out target/hyperion-schemas",
            "cargo run --quiet --bin hyperion -- c-header write --out target/hyperion-sdk/include/hyperion_emv.h",
            ...
            "python3 -m hyperion_tools.cli index --root target/hyperion-submission-pack --out target/hyperion-submission-pack/python_index.json",
            "make verify",
        ],
        ci_gate: "CLI smoke; schema/header generation; release-freeze smoke; full verify target",
        status: "repo-controlled",
    ...
    VerificationMechanism {
        ...
        ci_gate: "Certification artifact import plan drift; artifact import, integration import, and release freeze smoke",
        status: "repo-controlled",
        external_closure_gate: "CERT-OPEN-001 through CERT-OPEN-012",
    },
    VerificationMechanism {
